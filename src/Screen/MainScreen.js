...
const activities = [
  {
    ...
    name: 'Hyejin',
    desc: 'Visit the district office to ...',
  },
  {
    time: '10:00 May 11, 2025',
    name: 'Mr. Choi',
    desc: 'Grocery shopping at E ...',
  },
  {
    time: '18:00 May 21, 2025',
    name: 'Minjae',
    desc: 'Attend a counseling sessio ...',
  },
];
...
export default function VolunteerActivitiesScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      <Image source={require('../../assets/carebind_logo.png')} style={styles.logo} />
      <Text style={styles.greeting}><Text style={{fontWeight:'bold'}}>Alex,{"\n"}thank you again today!</Text></Text>
      ...
      <Modal visible={modalVisible} transparent animationType="fade">
        <View style={styles.modalContainer}>
          <View style={styles.detailCard}>
            <Image source={require('../../assets/carebind_logo.png')} style={styles.modalLogo} />
            {selectedActivity && (
              <>
